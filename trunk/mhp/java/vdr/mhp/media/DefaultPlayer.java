...
/* Implements all interface with trivial return values.
*/

public class DefaultPlayer implements Player, Clock, Controller, javax.media.Duration, MediaHandler {

...
Taken and adapted from:
   ...
   MHPGlyphVector.java -- Glyph vector object
...
public class MHPGlyphVector extends GlyphVector
{
  ...
  public boolean equals(GlyphVector gv)
{
    ...
    if (! (gv instanceof MHPGlyphVector))
      return false;

    MHPGlyphVector ggv = (MHPGlyphVector) gv;

...
/**
 * Helper class to MHPImage. Sits and gathers pixels for a MHPImage and then
 * calls MHPImage.setImage().
 *
 * @author Sven de Marothy
 */
public class MHPImageConsumer implements ImageConsumer
{
  private MHPImage target;
  private int width, height;
  private Hashtable properties;
  private int[] pixelCache = null;
  private ImageProducer source;

  public MHPImageConsumer(MHPImage target, ImageProducer source)
  {
    this.target = target;
    this.source = source;
  }
  ...
  public synchronized void setImage(DFBImageProvider provider) {
				      ...
				      int offset, int scansize)
  {
    ...
    if (cm.equals(MHPImage.nativeModel))

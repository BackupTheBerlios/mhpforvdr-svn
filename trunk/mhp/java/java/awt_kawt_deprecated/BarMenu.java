...
//	new BarMenuListener();
	...
	// this (to avoid getting clipped away)
        return DVBNativeGraphics.getGraphics( parent,
            ( ( Window )parent ).nativeData, DVBNativeGraphics.TGT_TYPE_WINDOW,
            u, v, 0, 0, width, height, parent.fgClr, parent.bgClr,
            parent.font, false );
    }
    ...
    void registerHandlers() {
        ...
        MouseMotionAdapter mma = new MouseMotionAdapter() {
            public void mouseMoved( MouseEvent evt ) {
                if ( ( AWTEvent.keyTgt == evt.getSource() ) ||
                    ( current != null ) ) {

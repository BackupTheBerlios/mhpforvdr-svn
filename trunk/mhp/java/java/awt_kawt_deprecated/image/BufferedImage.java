  ...
  implements WritableRenderedImage
{
  ...
  {
    //kaffe did not implement this. They did this:
  
    //throw new UnsupportedOperationException("not implemented");
    // // will require a lot of effort to implement
    
    //Taking implementation from org.dvb.ui.DVBBufferedImage; same base class.
        Graphics g;
        org.dvb.ui.DVBGraphics dvbgra = null;
        //System.out.println( "DVBBufferedImage.createGraphics() called." );
        g = super.getGraphics();
        if ( g instanceof org.dvb.ui.DVBGraphics ) {
            // really should always be true in our context!
            return g;
        } else {
            System.out.println( "DVBBufferedImage.createGraphics(): detected a major inconsistency: super.getGraphics() returned an object that is not an instance of DVBGraphics. " + g );
            return null;
        }
  }

...
static DFBResult
system_initialize( /*21*/CoreDFB *coredfb, void **data )
{
     ...
     core=coredfb;
     CoreScreen *screen=dfb_screens_register( NULL, NULL, &shmPrimaryScreenFuncs );
     dfb_layers_register( screen, NULL, &shmPrimaryLayerFuncs );

     return DFB_OK;
}

static DFBResult
system_join( /*21*/CoreDFB *core, void **data )
{

                                 ...
                                 CoreLayerRegionConfigFlags *failed )
{
     ...
     printf("primaryTestConfiguration: %d %d %d %d %d, failed %d\n", config->width, config->height, config->format, config->buffermode, config->options, fail);
                                     ...
                                     CoreSurface           **ret_surface )
{
     ...
     printf("primaryAllocateSurface %d %d %d %d %d\n", config->width, config->height, config->format, config->buffermode, config->options);
                                     ...
                                     CoreSurface            *surface )
{
   ...
   printf("Surface config: %d %d %d\n", surface->width, surface->height, config->format);
   
   if (config->width != surface->width ||
       config->height != surface->height ||
       config->format != config->format) {
      printf("Error: Real reallocation not supported\n");
      return DFB_UNSUPPORTED;
   }

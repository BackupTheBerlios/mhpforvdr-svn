 ...
 * Written By: Immo Benjes Date: 14 Oct 99 Description: Usage Notes:
 * Filename: UnsupportedDrawingOperationException.java
 * @author Immo Benjes Last change:  IB   19 Jan 100   10:39 am
 */
 ...
 * when setting the SRC_OVER rule on some devices while the SRC rule
 * will always work.
 * @since MHP 1.0
 */
public class UnsupportedDrawingOperationException extends Exception {
    /**
     * Constructs an instance of <code>UnsupportedDrawingOperationException</code>

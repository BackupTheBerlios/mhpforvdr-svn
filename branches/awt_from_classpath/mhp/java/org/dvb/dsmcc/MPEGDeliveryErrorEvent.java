...
/*An MPEGDeliveryErrorEvent indicates that an error (for instance, a time out or accessing 
the data would require tuning) has occurred while loading data from an MPEG 
Stream. */

public class MPEGDeliveryErrorEvent extends AsynchronousLoadingEvent {

/*
Creates an MPEGDeliveryEvent. Parameters: o - the DSMCCObject that generated the 
event. */

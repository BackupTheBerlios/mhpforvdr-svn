...
public class Insets implements Cloneable, Serializable {
    /**
     * @serial The inset from the top.  This value is added to the Top of the
     * rectangle to yield a new location for the Top.
     */
    public int top;

    /**
     * @serial The inset from the left.  This value is added to the left of
     * the rectangle to yield a new location for the left edge.
     */
    public int left;

    /**
     * @serial The inset from the bottom.  This value is added to the Bottom
     ...
     */
    public int right;
    public static Insets noInsets = new Insets();

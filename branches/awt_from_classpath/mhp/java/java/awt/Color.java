...
public class Color implements Paint, Serializable
{
  ...
  public static final Color white = new org.dvb.ui.DVBColor( 255, 255, 255, 255 );
  ...
  public static final Color lightGray = new org.dvb.ui.DVBColor( 192, 192, 192, 255 );
  ...
  public static final Color gray = new org.dvb.ui.DVBColor( 128, 128, 128, 255 );
  ...
  public static final Color darkGray = new org.dvb.ui.DVBColor( 64, 64, 64, 255 );
  ...
  public static final Color black = new org.dvb.ui.DVBColor( 0, 0, 0, 255 );
  ...
  public static final Color red = new org.dvb.ui.DVBColor( 255, 0, 0, 255 );
  ...
  public static final Color pink = new org.dvb.ui.DVBColor( 255, 175, 175, 255 );
  ...
  public static final Color orange = new org.dvb.ui.DVBColor( 255, 200, 0, 255 );
  ...
  public static final Color yellow = new org.dvb.ui.DVBColor( 255, 255, 0, 255 );
  ...
  public static final Color green = new org.dvb.ui.DVBColor( 0, 255, 0, 255 );
  ...
  public static final Color magenta = new org.dvb.ui.DVBColor( 255, 0, 255, 255 );
  ...
  public static final Color cyan = new org.dvb.ui.DVBColor( 0, 255, 255, 255 );
  ...
  public static final Color blue = new org.dvb.ui.DVBColor( 0, 0, 255, 255 );
...
//  private boolean nativeValueIsInitialized = false;
   ...
   final public int getNativeValue() {
      return value;
   }
  ...
  public Color brighter()
  {
    ...
    int tempValue = getRGB();
    int tempRed = (tempValue & RED_MASK) >> 16;
    int tempGreen = (tempValue & GREEN_MASK) >> 8;
    int tempBlue = tempValue & BLUE_MASK;
    // We have to special case 0-2 because they won't scale by division.
    tempRed = tempRed < 3 ? 3 : (int) Math.min(255, tempRed / BRIGHT_SCALE);
    tempGreen = tempGreen < 3 ? 3 : (int) Math.min(255, tempGreen / BRIGHT_SCALE);
    tempBlue = tempBlue < 3 ? 3 : (int) Math.min(255, tempBlue / BRIGHT_SCALE);
    return new DVBColor(tempRed, tempGreen, tempBlue, 255);
  }
  ...
  public Color darker()
  {
    // Do not inline getRGB() to this.value, because of SystemColor.
    int tempValue = getRGB();
    return new DVBColor((int) (((tempValue & RED_MASK) >> 16) * BRIGHT_SCALE),
                     (int) (((tempValue & GREEN_MASK) >> 8) * BRIGHT_SCALE),
                     (int) ((tempValue & BLUE_MASK) * BRIGHT_SCALE), 255);
  }
  ...
  {
    return new DVBColor(Integer.decode(str).intValue(), false);
  }
  ...
  public static Color getColor(String prop, Color defcolor)
  {
    ...
    return val == null ? defcolor
      : new DVBColor(val.intValue(), false);
  }
  ...
  public static Color getColor(String prop, int defrgb)
  {
    ...
    return c == null ? new DVBColor(defrgb, false) : c;
  }
  ...
  public static Color getHSBColor(float hue, float saturation,
                                  float brightness)
  {
    return new DVBColor(HSBtoRGB(hue, saturation, brightness), false);
  }
    ...
    if (frgbvalue == null)
      {
        // Do not inline getRGB() to this.value, because of SystemColor.
        int tempValue = getRGB();
        frgbvalue = new float[] { ((tempValue & RED_MASK) >> 16) / 255f,
                                  ((tempValue & GREEN_MASK) >> 8) / 255f,
                                  (tempValue & BLUE_MASK) / 255f };
      }
    array[0] = frgbvalue[0];
    array[1] = frgbvalue[1];
    array[2] = frgbvalue[2];

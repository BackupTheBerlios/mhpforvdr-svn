...
//adaption for MHP is merely java.awt.Window -> java.awt.MHPPlane,
//removal of getTopLevel from AWTEvent
  ...
  extends FocusEvent
{
	...
	static MHPPlane newActiveWindow;
...
protected void dispatch () {
	...
	if ( id == FOCUS_GAINED ) {
		if ( (keyTgtRequest != null) ) {
			...
			if ( keyTgtRequest.getToplevel() == src )
				src = keyTgtRequest;
			keyTgtRequest = null;
		}		
		...
		newActiveWindow = (MHPPlane) src.getToplevel();

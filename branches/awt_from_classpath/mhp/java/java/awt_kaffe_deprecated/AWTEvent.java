  ...
  extends EventObject
{
   ...
   final public static long INPUT_METHOD_EVENT_MASK = 0x800;
...
protected void dispatch () {
   System.out.println("AWTEvent.dispatch this "+this+" to "+((Component)source));
...
/*static void registerSource ( Component c, long nativeData ) {
...
/*static void unregisterSource ( Component c, long nativeData ) {
